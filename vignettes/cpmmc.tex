...
+ )
> # Random Effect PM (specific case inherited from cpmmc class), rho =0
> rem_pm <- normal_random_effect_model(data,
+                                   theta_0 = 0,
+                                   u_0 = u_0,
+                                   rho = rho,
+                                   log_theta_prior_density = log_theta_prior_density,
...
> rem_pm <- run_chain(rem_pm, chain_length = nsim)
> 
\end{Sinput}
\end{Schunk}
